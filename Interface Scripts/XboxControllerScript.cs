...
public class XboxControllerScript : MonoBehaviour {
	...
	void OnGui ()
	{
			...
			GUI.Label (new Rect (340, 40, 125, 20), "Xbox 360 Contoller");
			...
			GUI.Label (new Rect (25, 125, 125, 20), "Item1: ");
		...
		if (!ShowPopup) 
		{
			...
			if(GUI.Button(new Rect(150, 125, 135, 20), PC_Item2))
			{
				ShowPopup = true;
				PreviousKey = pcItem1;
			}
			...
			if(GUI.Button(new Rect(150, 125, 135, 20), PC_Item3))
			{
				ShowPopup = true;
				PreviousKey = pcItem1;
			}
			if(GUI.Button(new Rect(150, 125, 135, 20), PC_Item4))
			{
				ShowPopup = true;
				PreviousKey = pcItem1;
			}
			if(GUI.Button(new Rect(150, 125, 135, 20), PC_Pause))
			{
				ShowPopup = true;
				PreviousKey = pcItem1;
			}
			if(GUI.Button(new Rect(150, 250, 135, 20), PC_Inv))
			{
				ShowPopup = true;
				PreviousKey = pcItem1;
			}
			...
			GUI.BeginGroup (new Rect (Screen.width / 2 - 300, Screen.height / 2 -
				300, 600, 400));
